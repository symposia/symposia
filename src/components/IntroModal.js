...
const tutorialSteps = [
  ...
  },
  {
    ...
    imgPath: IntroModal2,
    description:
      "1. Important concepts and ideas in the news articles are linked together in groups based on their correlation. You can hover over concepts to see where the clusters are."
  },
  {
    // label: 'Bali, Indonesia',
    imgPath: IntroModal3,
    description:
      "2. Clicking on a concept in the concept graph will show all the articles that contain that concept and its neighbors"
  },
  {
    // label: 'NeONBRAND Digital Marketing, Las Vegas, United States',
    imgPath: IntroModal4,
    description:
      "3. Click on an article card to read that article and look at similar and different perspectives"
  },
  {
    // label: 'Goč, Serbia',
    imgPath: IntroModal5,
